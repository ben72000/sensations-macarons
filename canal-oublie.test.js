...
function buildModule(){
  const code = `
    ...
    return { caMarcheEncaisse, caMarchesDuMois, caEncaisseParMois, caMoisEncaisse,
             serieMensuelleEncaisse, orderToLines };
  `;
...
const MOVES = [
  { marketId:9, type:'embarque', qte:150 },
  { marketId:9, type:'retour',   qte:30  },
  { marketId:9, type:'perte',    qte:5   }
];   // vendu = 150 − 35 = 115

{
  ...
  eq(E.macaronsStd, 315, 'C5 · 200 (commande) + 115 vendus au marché (150 embarqués − 30 retours − 5 pertes)');
