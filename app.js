...
// Clés localStorage à inclure dans les sauvegardes (réglages qui ne sont pas en base).
const BACKUP_LS_KEYS = ['sm_settings','sm_autoPay','sm_lastExport','sm_autoBackupDate'];
